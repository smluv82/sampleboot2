...
@Slf4j
public class BithumbRestTemplate extends RestOperationImpl implements IRestTemplate {

	public BithumbRestTemplate(RestOperations restOperation, String host, String port){
